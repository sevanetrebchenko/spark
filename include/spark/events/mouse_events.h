...
namespace Spark {
    namespace Events {
        ...
        class MouseButtonPressedEvent : public Event {
            public:
                static inline constexpr EventType GetStaticEventType() { return EventType::MouseButtonPressed; }
        ...
        class MouseButtonReleasedEvent : public Event {
            public:
                static inline constexpr EventType GetStaticEventType() { return EventType::MouseButtonReleased; }
        ...
        class MouseScrolledEvent : public Event {
            public:
                static inline constexpr EventType GetStaticEventType() { return EventType::MouseScrolled; }
        ...
        class MouseMovedEvent : public Event {
            public:
                static inline constexpr EventType GetStaticEventType() { return EventType::MouseMoved; }
