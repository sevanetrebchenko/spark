        ...
        namespace Logger {
            ...
            class ILoggingHub {
                public:
                    ...
                    NODISCARD virtual IAdapter* GetCustomAdapter(const char* name) = 0;
                    virtual void DetachCustomAdapter(IAdapter* adapter) = 0;

                    NODISCARD virtual const std::chrono::time_point<std::chrono::high_resolution_clock>& GetInitializationTime() = 0;
