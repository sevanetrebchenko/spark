...
#include "../../../include/spark/utilitybox/logger/log_message.h"              // LogMessage, LogMessageSeverity
#include "../../../include/spark/utilitybox/tools/global_defines.h"            // _NODISCARD_
